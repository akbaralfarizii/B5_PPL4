  ...
  return (
    <>
      <CRow>
        <CCol md={12}>
        <CCard>
              <CCardHeader className='bg-dark text-white'><b>Data Peserta Fit & Propper</b>
              </CCardHeader>
              <CCardBody>
                <CInputGroup>
              ...
              <CTable striped hover bordered>
                <CTableHead color="dark" align="center">
                  <CTableRow>
                    ...
                    <CTableHeaderCell scope="col">Tanggal Fit and Proper</CTableHeaderCell>
                ...
                <CTableBody>
                  {nilaiFitAndPropper.filter((todo)=>{
                    ...
                    <CTableRow>
                      ...
                      <CTableDataCell>                  
                        <Link to={'/report/rekapnilaifit&propper/lihatnilaifit&propper'}>
                          <CButton className='btn btn-sm btn-info text-white'>
                            Lihat Nilai
                          </CButton>
                        </Link>
                    </CTableDataCell>
