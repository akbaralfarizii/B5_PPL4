...
//--Data Penguji
const urlpenguji = 'http://localhost:1337/api/pengujis?populate[0]=pegawai.jabatan&populate[1]=pegawai.grade&populate[2]=pegawai.jenjang';
export const Penguji = () => axios.get(urlpenguji);

//--Data Pegawai
const urlpegawais = 'http://localhost:1337/api/pegawais?populate[0]=jabatan&populate[1]=grade&populate[2]=jenjang';
